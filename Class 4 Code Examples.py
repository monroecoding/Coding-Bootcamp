...
fruit_list[1] = "lemon"
print(fruit_list) #lists are mutable, we can change individual elements using assignment
...
#tuples work similarly to lists but are immutable, meaning the data inside cannot be changed
